  ...
  ({
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              ...
              "text-white crt-logo-effect crt-logo-colorful",
              "transition-[color,filter,transform] duration-300 ease-out",
              scaleOnHover && "group-hover/item:scale-120",

              "group-hover/item:text-[var(--brand-color)]",

              "group-hover/item:drop-shadow-[0_0_10px_var(--brand-color)]",
            )}
            aria-hidden={!!(item as any).href && !(item as any).ariaLabel}
            style={
              {
                "--brand-color": (item as any).brandColor,
              } as React.CSSProperties
            }
          >
            {(item as any).node}
    ...
    return (
      ...
      >
        ...
        {/* Efek Vignette (opsional: sudut gelap agar lebih CRT) */}
        <div className="pointer-events-none absolute inset-0 z-40 shadow-[inset_0_0_40px_rgba(0,0,0,0.5)]" />
        <div
          className={cx(
